...
export function addMovieToPlaylist(movieId, playlistId, currentUser) {
    ...
    return async (dispatch) => {
        ...
        try {
            ...
            if (movieId && playlistId && currentUser) await axios.put(`https://pf-henry-back.herokuapp.com/list/addMovie/${playlistId}/${movieId}`, {}, { headers: { 'user': currentUser.accessToken } })
...
export function removeMovieFromPlaylist(movieId, playlistId, currentUser) {
    ...
    return async (dispatch) => {
        ...
        try {
            ...
            await axios.put(`https://pf-henry-back.herokuapp.com/list/removeMovie/${playlistId}/${movieId}`, {}, { headers: { 'user': currentUser.accessToken } })

            return dispatch({ type: 'REMOVE_MOVIE_FROM_PLAYLIST', payload: movieId})
