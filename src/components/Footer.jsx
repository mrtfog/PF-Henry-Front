                    ...
                    <div className={style.social}>
                        ...
                        <a href='#'>
                            <span className={`${style.fab} ${style.fa_facebook_f}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="40px" width="40px" fill="#000">
                ...
                <div className={style.content}>
                    ...
                    <div className={style.phone}>
                        ...
                        <span className={`${style.fas} ${style.fa_phone_alt}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="40px" width="40px" fill="#000">
                    ...
                    <div className={style.email}>
                        ...
                        <p className={style.text}>contact@hpfc.com</p>
