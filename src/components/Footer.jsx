                    ...
                    <div className={style.social}>
                        ...
                        <a href='#'>
                            <span className={`${style.fab} ${style.fa_facebook_f}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="40px" width="40px">
                ...
                <div className={style.content}>
                    <div className={style.place}>
                        ...
                        <span className={`${style.fas} ${style.fa_map_marker_alt}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" height="40px" width="40px" >
                        ...
                        <span className={style.text}>Madrid, Spain</span>
                    ...
                    <div className={style.phone}>
                        ...
                        <span className={style.text}>0800-999-9999</span>
                    ...
                    <div className={style.email}>
                        ...
                        <span className={style.text}>contact@hpfc.com</span>
