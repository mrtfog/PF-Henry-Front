      ...
      <div className={style.form_container}>
        ...
        <form>
          ...
          <div className={style.inputContainer}>
            ...
            <div id="showButton" className={style.showButton} onClick={handleClick}>
              {type === "password" ? (
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="22px" height="16px" viewBox="0 0 31 32" xmlSpace="preserve">
          ...
          <div className={style.btnContainer}>
            <button className={style.primaryBtn} type="submit" onClick={(e) => handleOnSubmit(e)} disabled={Object.keys(errors).length !== 0 ? true : false} > Log in </button>
