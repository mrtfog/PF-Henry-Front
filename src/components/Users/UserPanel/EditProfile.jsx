          ...
          <div className={style.fieldsContainer}>
            ...
            <div className={style.field}>
              ...
              <div className={`${style.inputContainer} ${style.username}`}>
                ...
                <span
                  onClick={() => changeUsername(currentUser)}
              ...
              {subInfo ? (
                <>
                  <CardPayments
                    ...
                    date={new Date(subInfo.lastPayment.dateTime).toDateString()}
                    amount={subInfo.lastPayment.price}
                  ></CardPayments>
                  <button
                ...
                <div className={style.unsubscribedContainer}>
                  ...
                  <NavLink className={style.subButton} to="/subscribe">
                    Subscribe now!
                  </NavLink>
                </div>
              )}
